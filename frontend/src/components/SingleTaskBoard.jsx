...
function SingleTaskBoard() {
	...
	return (
		<>
			<div className="p-10">
				<div className="w-[1060px] h-[530px] rounded-[30px] border-[10px] border-[#363636] bg-[#C2DCEB] shadow-2xl p-1">
					<div className="p-3 flex justify-center items-center w-full h-full rounded-3xl">
						<div className="w-[38%] h-full flex flex-col justify-start items-center">
							<h2 className="self-start font-outfit font-[700] text-[80px] text-[#363636] tracking-tighter">
								{task?.title}
							</h2>
						...
						<div className="w-[62%] h-full flex flex-col justify-start items-center ps-6 pt-1">
							...
							<div className="w-full flex justify-around items-center font-outfit text-[48px] font-[700] text-[#363636] tracking-tight ">
								<button
									className={`h2 ${
										activeTab === 'subtasks'
											? 'text-[#681FDE]'
								...
								{activeTab === 'subtasks' && task?.subtasks ? (
									<div>
										{task.subtasks.map((subtask) => (
											<SingleTaskSubtask key={subtask._id} subtask={subtask} />
										))}
									</div>
								) : (
