...
//   const productLeaderName = users.find(user => user.name === "John Doe");
...
//   const nextTasks = () => {
//     setStartIndex(prevIndex => Math.min(prevIndex + 1, unassignedTasks.length - 1));
//   };
...
//       <div className='flex justify-center items-center border-[2px] border-gray-900 rounded-[30px] w-[900px] h-[460px] overflow-auto'>
...
//                     <h3 className='text-xs font-semibold'>Title: {task.title}</h3>
//                   </div>
//                   <img src='./src/assets/wireanchor2.png' alt='Avatar' className='ml-4 w-[21px] h-[13px]'/>  
//                 </div>
               
//                 {productLeaderName && (
//   <div>
//     <p key={productLeaderName.id}></p>
//     <div className='flex justify-end'>
//       <p className='font-bold'>
//         <div className='flex justify-between mr-[12px]'>
//           <div className='flex justify-center'>
//             {productLeaderName.profilePicture && <Avatar src={productLeaderName.profilePicture} alt="" className='w-[30px] h-[30px]' />}
...
//                   <p className='text-xs text-blue-600 ml-10'>{task.description}</p>
...
//                     <p><span className='font-bold ml-2'>Priority:</span> {task.priority}</p>
//                     <p><span className='font-bold ml-2'>Status:</span> {task.status}</p>
//                     <p><span className='font-bold ml-2 text-red-400'>Deadline:</span> {task.deadline && new Date(task.deadline).toLocaleDateString()}</p>
//                   </div>
//                 </div>
