...
// const formattedDeadline = `${month}/${day}/${year}`;
                   ...
                   <p className='font-bold'>
                    ...
                    <div className='flex justify-between mr-[12px]'>
                      <div className='flex justify-center'>
                           <Avatar src={productLeaderName.profilePicture} alt="" className='w-[30px] h-[30px]' />
  ...
  <p>
    <span className='font-bold ml-2'>Priority:</span> {task.priority}
  </p>

  <p>
    <span className='font-bold ml-2'>Status:</span> {task.status}
  </p>

  <p>
    <span className='font-bold ml-2 text-red-400'>Deadline:</span> {task.deadline && new Date(task.deadline).toLocaleDateString()}
  </p>
</div>
